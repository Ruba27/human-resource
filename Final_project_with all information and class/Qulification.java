...
// TODO add your handling code here:
    ...
    public void insertQulification() {
...
// the obove stamteent to insert to table at my sql
    ...
    public void deleteQulification() {
        Statement stmt;
        ...
        try {
            ...
            qulificationID = this.id.getText(); // get id from text field

            stmt.executeUpdate("Delete From qulification Where Qid =('" + qulificationID + "')");
    ...
    public void updateQulification() {
        Statement stmt;// define statment to make connect to sql
        ...
        try {
            ...
            String newValue, oldVlaue, qulificationID;// define variable as string
            qulificationID = this.id.getText();// // put id from text field
            newValue = this.update2.getText();// put new value that upadted
            oldVlaue = this.coloum.getText();// old coloums which need update value

            stmt.executeUpdate("update qulification set " + oldVlaue + " = ('" + newValue + "')where Qid=('" + qulificationID + "')");  // the  stamteent to update to table at my sql
            con.close();// close connection
        } catch (Exception ee) {
            System.out.println(ee.toString());
        }        // TODO add your handling code here:
    ...
    public void selectQulification() {
